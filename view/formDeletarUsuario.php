...
<form id="formusu" method="POST" action="../controller/deletarUsuario.php">
...
<div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="email" required class="form-control" readonly value="<?= $usuario["emailusu"] ?>" id="Email" aria-describedby="emailHelp">
  </div>
